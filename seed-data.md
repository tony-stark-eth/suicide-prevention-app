...
## Usage
Use this data in `src/DataFixtures/CrisisResourceFixtures.php`.
All records must be loaded via Doctrine fixtures, not hardcoded in controllers.
...
## Crisis resources (all 20 countries)
...
These numbers were verified as of early 2026 but should be reverified before launch.
The findahelpline.com API can be used as a live fallback for countries where no local number is available.
Register for their API at: https://findahelpline.com/about/api
